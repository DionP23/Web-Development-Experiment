                                        ...
                                        <div class="col-8">
                                            <form action="store.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-input mb-5">
                                                    ...
                                                    <textarea placeholder="Input deskripsi dari barang" name="description" id="description" rows="4" cols="3" class="form-control"></textarea>
                                                </div>
                                                <div class="form-input mb-5">
                                                    <label for="price">Price</label>
                                                    <input placeholder="Input harga dari barang baru" type="number" name="price" id="price" class="form-control">
                                                </div>
                                                <div class="form-input mb-5">
