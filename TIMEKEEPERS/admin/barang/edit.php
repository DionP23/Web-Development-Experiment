...
$data = $query->select()->from('barang')->where('id', $_GET['id'])->get();
                                        ...
                                        <div class="col-8">
                                            <form action="update.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-input mb-5">
                                                    ...
                                                    <input placeholder="Input nama barang" type="text" name="name" id="name" class="form-control" value="<?= $data[0]->name ?>">
                                                </div>
                                                <img src="../../assets/img/barang/<?= $data[0]->image ?>" alt="" class="img-fluid">
                                                <p class="text-muted">Review Image sebelumnya.</p>
                                                <div class="form-input mb-5">
                                                    <label for="image">Image</label>
                                                    <input type="file" name="image" id="image" class="form-control">
                                                </div>
                                                <input type="hidden" name="imageLama" value="<?= $data[0]->image ?>">
                                                <div class="form-input mb-5">
                                                    <label for="description">Description</label>
                                                    <textarea placeholder="Input deskripsi dari barang" name="description" id="description" rows="4" cols="3" class="form-control"><?= $data[0]->description ?></textarea>
                                                </div>
                                                <div class="form-input mb-5">
                                                    <label for="price">Price</label>
                                                    <input placeholder="Input harga dari barang baru" type="number" name="price" id="price" class="form-control" value="<?= $data[0]->price ?>">
                                                </div>
                                                <div class="form-input mb-5">
