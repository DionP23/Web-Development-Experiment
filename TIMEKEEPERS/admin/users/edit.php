...
$data = $query->select()->from('users')->where('id', $_GET['id'])->get();
                        ...
                        <div class="col">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Create data Users</h6>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="col-8">
                                            <form action="update.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-input mb-5">
                                                    ...
                                                    <input type="password" name="password" id="password" class="form-control" value="<?= $data[0]->password ?>">
                                                </div>
                                                <div class="form-input mb-5">
                                                    <label for="password">Level</label>
                                                    <select name="level" class="form-control">
                                                        <option value="<?= $data[0]->level ?>"><?= $data[0]->level ?></option>
